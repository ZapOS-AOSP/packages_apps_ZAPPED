...
import com.zapped.settings.preferences.SecureSettingMasterSwitchPreference;
import com.zapped.settings.preferences.SystemSettingEditTextPreference;
...
public class QuickSettings extends DashboardFragment implements
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.zap_settings_quicksettings;
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (footerString != null && !footerString.isEmpty())
            ...
            mFooterString.setText("ZAP");
            Settings.System.putString(resolver,
                    Settings.System.QS_FOOTER_TEXT_STRING, "ZAP");
        }
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.zap_settings_quicksettings);
}
