...
import com.zapped.settings.Utils;
...
public class NotificationsSettings extends DashboardFragment implements
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.zap_settings_notifications;
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (!ZapUtils.deviceHasFlashlight(getActivity())) {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.zap_settings_notifications);
}
